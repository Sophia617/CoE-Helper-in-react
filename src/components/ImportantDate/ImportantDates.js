...
const ImportantDates = () => {
    return (
        <Wrapper id="importantDates">
            <Container>
                <h1><i className="fas fa-calendar-alt"></i>  Important Dates </h1><br/>
                <DateTable /><br/>
                <CoursesByCalendar /><br/>
                <AlertMessage variant='info' href="https://www.handbook.uts.edu.au/dates_academic.html"
                              message1 = "Click" linkText = 'HERE'
                              message2= " for UTS Academic Calendar 2020 (open in a new tap)."/>
                <AlertMessage variant='warning' href="https://www.handbook.uts.edu.au/dates.html"
                              message1 = "Click" linkText = 'HERE'
